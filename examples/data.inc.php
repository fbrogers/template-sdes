<?php if(!isset($data) or !$data instanceof TemplateData) die('Template has no data!');
	...
	as a key/value pair, with the key representing the href of the navigation link
	and the value representing the text to place within the anchor. as external
	...
	---------------------------------------------------------------------------- */
	$data->site_billboard_allowed_pages(NULL);
	...
	---------------------------------------------------------------------------- */
	$data->site_footer_ucf_icon(NULL);
